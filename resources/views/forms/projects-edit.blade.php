                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="project_status" name="project_status" required>
                                    ...
                                    <option value="Planning" {{ old('project_status', $project->project_status) == 'Planning' ? 'selected' : '' }}>Planning</option>
                                    <option value="In Progress" {{ old('project_status', $project->project_status) == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                            ...
                            <div class="col-md-6">
                                ...
                                @if($project->image_path)
                                    <small class="text-muted">Current: {{ basename($project->image_path) }}</small>
                                @endif
                            </div>
                            <div class="col-12">
