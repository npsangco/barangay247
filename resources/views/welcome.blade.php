                        ...
                        <div class="px-8 py-10">
                            ...
                            <ul class="space-y-3.5 mb-8 px-2">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700">Access officials contact info</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                    </svg>
                                    <span class="text-gray-700">Stay informed on incidents</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                    </svg>
                                    <span class="text-gray-700">View household information</span>
                                </li>
                            </ul>
                        ...
                        <div class="px-8 py-10">
                            ...
                            <ul class="space-y-3.5 mb-8 px-2">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700">Track barangay projects</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-gray-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700">Generate barangay reports</span>
                                </li>
                            </ul>
