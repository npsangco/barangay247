                ...
                <div class="p-6">
                    ...
                    <form action="{{ url('/officials') }}" method="GET" class="mb-6">
                        <div class="flex gap-2">
                            ...
                            @if(request('search'))
                                <a href="{{ route('officials.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">
                                    Clear
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Term Period</th>
                            ...
                            @forelse($officials as $official)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $official->official_name }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">No officials found.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
