    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('resident.my-info') }}" class="block">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
                        <div class="p-6">
                            <div class="flex items-center mb-3">
                                <svg class="w-8 h-8 text-purple-600 dark:text-purple-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">My Information</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">View and update your personal information</p>
                        </div>
                    </div>
                </a>

                <!-- Barangay Projects Module -->
                <a href="{{ route('projects.resident') }}" class="block">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
                        <div class="p-6">
                            <div class="flex items-center mb-3">
                                <svg class="w-8 h-8 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Barangay Projects</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">View ongoing and completed barangay projects</p>
                        </div>
                    </div>
                </a>

                <!-- My Incident Reports Module -->
                <a href="{{ route('incidents.resident') }}" class="block">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
                        <div class="p-6">
                            <div class="flex items-center mb-3">
                                <svg class="w-8 h-8 text-red-600 dark:text-red-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">My Incident Reports</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">View your reports and submit new incidents</p>
                        </div>
                    </div>
                </a>
            </div>
